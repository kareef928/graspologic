...
class TestLatentDistributionTest(unittest.TestCase):
    ...
    def test_n_bootstraps(self):
        ...
        _, _, null_distribution_ = ldt_function(A1, A2, n_bootstraps=123)
    ...
    def test_SBM_dcorr(self):
        ...
        A2 = sbm(2 * [b_size], B1)
        A3 = sbm(2 * [b_size], B2)
        p_null, _, _ = ldt_function(A1, A2)
        p_alt, _, _ = ldt_function(A1, A3)
    ...
    def test_different_sizes_null(self):
        ...
        p_corrected_1, _, _ = ldt_function(
            A1,
            A2,
            test="hsic",
            metric="gaussian",
        ...
        p_corrected_2, _, _ = ldt_function(
            A2,
            A1,
            test="hsic",
            metric="gaussian",
    ...
    def test_different_aligners(self):
        ...
        p_val_2, _, _ = ldt_function(A1, A2, input_graph=False, align_type="sign_flips")
